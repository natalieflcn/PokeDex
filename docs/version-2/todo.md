...
- [ ] Review the current file system and refactor files (and folders, if necessary) to properly reflect the MVC model
  - [ ] Create public folder to serve static assets (i.e. fonts, images) instead of cluttering everything inside src folder
- [~] Switch from using Parcel to Webpack & Babel to bundle code
  ...
  - [~] Resolve file paths of images, favicon, CSS, and font files that were shifted around the project
